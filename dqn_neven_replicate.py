...
def train(model, start):
    ...
    action[0] = 1
    image_data, reward, terminal, a = game_state.frame_step(action)
    ...
    while iteration < model.number_of_iterations:
        ...
        image_data_1, reward, terminal, a = game_state.frame_step(action)
        ...
        if iteration % 25000 == 0:
            torch.save(model, "pm2/current_model_" + str(iteration) + ".pth")
        # if iteration % 25000 == 0:
